...
export const handler: Handler = async (event) => {
  ...
  if (inputObject) {
    ...
    const response = await openai.completions.create({
      ...
      prompt: `You are creating a short travel plan based on the user's travel personality, vacation's duration, maximum budget and current location. You're a vibrant and passionate travel planner. Return your result in the form of an object. 
      ***
